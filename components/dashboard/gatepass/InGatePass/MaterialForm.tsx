...
export default function MaterialForm() {
    const [materialItems, setMaterialItems] = useState([
        { sno: 1, itemName: '', description: '', quantity: '', unit: '', invoiceNo: '' }
      ]);
    const [ListItem, setListItem] = useState("false")
      const handleAddItem = () => {
        ...
        setMaterialItems([
          ...materialItems,
          { sno: newSno, itemName: '', description: '', quantity: '', unit: '', invoiceNo: '' }
        ]);
      };
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      <CommonInput value={``} placeholder={`Visitor/Contractor/Supplier`} label={`Company Name`} required={true} combo={undefined} className={undefined} />
      ...
      <CommonInput value={``} placeholder={`Purpose of Visit`} label={`Purpose of Visit`} required={true} combo={undefined} className={undefined} />
      <SelectInput value={``} placeholder={`Select Contact Person`} label={`Contact Person`} required={true} />
      <div className="space-y-3">
