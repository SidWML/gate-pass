...
export default function Gatepass() {
  ...
  return (
    <div className=" space-y-6">
        ...
        <Link href='/dashboard/in-gatepass/add-in-gatepass' className='bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 gap-1'><Plus className='w-4 h-4' /> <span className="">New In Gatepass</span> </Link>
        </div>
        <div className="">
        <Table title={`Incoming Gate Passess`} data={visitorsData} />
        </div>
    </div>
  )
}
