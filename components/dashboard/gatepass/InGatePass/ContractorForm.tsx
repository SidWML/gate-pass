...
export default function ContractorForm() {
  return (
    <div className="  grid grid-cols-2 gap-4">
        <div className="flex items-center col-span-1 w-full gap-4">
          <SelectInput label={`Contractor Name`} className=""  placeholder={`Contractor Name`} required={true} />
          <SelectInput label={`Worker`} className=""  placeholder={`Worker`} required={true} />
        </div>
