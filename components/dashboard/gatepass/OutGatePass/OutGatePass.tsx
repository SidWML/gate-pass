...
export default function OutGatePass() {
    const visitorsData = {
        columns: [
          {
            field: "SNo",
        ...
        rows: [
            // Entry 1
            {
              ...
              VisitDateTime: { value: "2023-12-04 09:30 AM", width: "w-1/6" },
            ...
            // Entry 2
            {
              ...
              VisitDateTime: { value: "2023-12-05 10:45 AM", width: "w-1/6" },
            ...
            // Entry 3
            {
              ...
              VisitDateTime: { value: "2023-12-06 02:15 PM", width: "w-1/6" },
            ...
            // Entry 4
            {
              ...
              VisitDateTime: { value: "2023-12-07 11:00 AM", width: "w-1/6" },
            ...
            // Entry 5
            {
              ...
              VisitDateTime: { value: "2023-12-08 03:30 PM", width: "w-1/6" },
  ...
  return (
    <div className=" space-y-6">
        ...
        <Link href='/dashboard/out-gatepass/add-out-gatepass' className='bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 gap-1'><Plus className='w-4 h-4' /> <span className="">New Out Gatepass</span> </Link>
        </div>
        <div className="">
        <Table title={`Outgoing Gate Passess`} data={visitorsData} />
        </div>
    </div>
  )
}
